...
//
// Changelog:
// [2012-08-02] - Add option to specify a custom value on the fly [Anderson GrÃ¼dtner Martins]
...
function () {
    ...
    t = this, e = function () {
        function e(e, t) {
            this.form_field = e, this.options = t != null ? t : {}, this.set_default_values(), this.is_multiple = this.form_field.multiple, this.setup(), this.set_default_text(), this.set_up_html(), this.register_observers(), this.finish_setup()
        }
...
function () {
    ...
    r = this, e = jQuery, e.fn.extend({
        ...
        return s(i, t), i.prototype.setup = function () {
            return this.form_field_jq = e(this.form_field), this.current_value = this.form_field_jq.val(), this.is_rtl = this.form_field_jq.hasClass("chzn-rtl"), this.allow_custom_value = this.form_field_jq.hasClass("chzn-custom-value")
            ...
            var n, r, i, s, o, u, a;
            if (this.result_highlight) return r = this.result_highlight, i = r.attr("id"), this.result_clear_highlight(), this.is_multiple ? this.result_deactivate(r) : (this.search_results.find(".result-selected").removeClass("result-selected"), this.result_single_selected = r, this.selected_item.removeClass("chzn-default")), r.addClass("result-selected"), u = i.substr(i.lastIndexOf("_") + 1), s = this.results_data[u], s.selected = !0, this.form_field.options[s.options_index].selected = !0, this.is_multiple ? this.choice_build(s) : (this.selected_item.find("span").first().text(s.text), this.allow_single_deselect && this.single_deselect_control_build()), (!t.metaKey || !this.is_multiple) && this.results_hide(), this.search_field.val(""), (this.is_multiple || this.form_field_jq.val() !== this.current_value) && this.form_field_jq.trigger("change", {
                selected: this.form_field.options[s.options_index].value
            }), this.current_value = this.form_field_jq.val(), this.search_field_scale();
            if (!this.is_multiple && this.allow_custom_value) return a = this.search_field.val(), n = this.add_unique_custom_group(), o = e('<option value="' + a + '">' + a + "</option>"), n.append(o), this.form_field_jq.append(n), this.form_field.options[this.form_field.options.length - 1].selected = !0, t.metaKey || this.results_hide(), this.results_build()
        }, i.prototype.find_custom_group = function () {
            var t, n, r, i, s;
            s = e("optgroup", this.form_field);
            for (r = 0, i = s.length; r < i; r++) n = s[r], n.getAttribute("label") === this.custom_group_text && (t = n);
            return t
        }, i.prototype.add_unique_custom_group = function () {
            var t;
            return t = this.find_custom_group(), t || (t = e('<optgroup label="' + this.custom_group_text + '"></optgroup>')), e(t)
