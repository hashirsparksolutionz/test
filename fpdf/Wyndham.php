...
// set the sourcefile 
$pagecount = $pdf->setSourceFile('Reservation Request Form - Wyndham.pdf');
	// import page 1 
...
// use the imported page and place it at point 10,10 with a width of 100 mm 
	...
	/*$pdf->SetY(21);
	$pdf->SetX(177);*/
$pdf->Output($certificate.'-'.$job.'-Reservation Request Form - Wyndham.pdf', 'F'); /*require("fpdf.php");
ob_start("callback");
...
?>
<script language="javascript">window.location.href ="<?php echo $certificate  ?>-<?php echo $job  ?>-Reservation Request Form - Wyndham.pdf";</script>
