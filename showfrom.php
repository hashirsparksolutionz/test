    ...
    <div class="slide-wrapper">
       ...
       <form name="userinfo" id="userinfo" onSubmit="return reg_user();" method="post" action="">
			...
			<table border="0" class="form-tables" align="center" >
                ...
                <tr>
                  <td> Your Email<span class="starig">*</span></td>
                  <td><input type="text" style="border-radius: 5px;border:0.1em solid;height: 25px;width: 180px;" name="email1" id="email1" />
                    <br />
                    <span style="color:red" id="email_msg"></span></td>
                </tr>
                <tr>
                	<td>
                    	Your Friend's Email<span class="starig">*</span>
                    </td>
                    <td>
                     <input type="text" style="border-radius: 5px;border:0.1em solid;height: 25px;width: 180px;" name="email2" id="email2" /><br />
     <span style="color:red" id="email_msg"></span>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td align="right"><input type="submit" class="btn-11" name="check" value="Submit" style="border: none;
padding: 8px;
color: #fff;
