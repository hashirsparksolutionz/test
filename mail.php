...
Information Of Used certificates of ".$today."To Download as XLSX File Click or copy and paste the link in your browser.<a href='http://'".$_SERVER['SERVER_NAME']."'/Usedcerticate.xls' /> http://".$_SERVER['SERVER_NAME']."/Usedcerticate.xls </a>
--PHP-mixed-$random_hash
