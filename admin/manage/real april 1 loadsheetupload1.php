...
$sql="INSERT INTO `capXlsx` (`cname`, `job`, `certificate`, `concatenated`, `amount`, `shipCost`, `received`, `fulfilled`, `first`, `last`, `street` ,`city`, `state`, `zip`, `beginredemption`, `expiration`, `choice01`, `choice02`, `choice03`, `choice04`, `choice05`, `choice06`, `choice07`, `choice08`, `choice09`, `choice10`, `choice11`, `choice12`, `choice13`, `choice14`, `choice15`, `choice16`, `choice17`, `choice18`, `choice19`, `choice20`, `choice21`, `choice22`, `choice23`, `choice24`, `choice25`,`Timestamp_add) VALUES ('".$r[0]."','".$r[1]."','".$r[2]."','".$r[3]."','".$r[4]."','".$r[5]."','".$r[6]."','".$r[7]."','".$r[8]."','".$r[9]."','".$r[10]."','".$r[11]."','".$r[12]."','".$r[13]."','".$d."','".$e."','".$r[16]."','".$r[17]."','".$r[18]."','".$r[19]."','".$r[20]."','".$r[21]."','".$r[22]."','".$r[23]."','".$r[24]."','".$r[25]."','".$r[26]."','".$r[27]."','".$r[28]."','".$r[29]."','".$r[30]."','".$r[31]."','".$r[32]."','".$r[33]."','".$r[34]."','".$r[35]."','".$r[36]."','".$r[37]."','".$r[38]."','".$r[39]."','".$r[40]."','".$datetime."')";
