...
mysqli_query($con, $query) or mysqli_error($con);
	...
	*/
	/* }
	  ...
	  $query="UPDATE `products` SET `name_en`='".mysqli_real_escape_string(htmlentities($_POST['name_en']))."',`name_ar`='".mysqli_real_escape_string(htmlentities($_POST['name_ar']))."',`desc_en`='".mysqli_real_escape_string(htmlentities($_POST['desc_en']))."',`desc_ar`='".mysqli_real_escape_string(htmlentities($_POST['desc_ar']))."',`price`='".$_POST['price']."',`image`='".$old_img."' WHERE `id`='".$pid."'";
	mysqli_query($con, $query) or mysqli_error();
