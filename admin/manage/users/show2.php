...
<h2 class="table table-striped">Assigned Certificates[<?php echo $totalRecords;?>]</h2>
  <div align="right"><a href="?p=show2&com=empty" onClick= "return confirm('Do You Want To Delete All Certificates?')">Delete All Records</a></div>
...
// else if($exprydate >= date("m-d-Y")){
    ...
    ?></td>
            ...
            <td width="9%" align="left" valign="top"><span class="btn btn-small"> <i class="icon-edit "> </i> <a href="?p=edit&pid=<?php echo $cat_fetch_row['id']; ?>">Edit</a> </span> | <span href="#" class="btn btn-small"> <i class="icon-delete "> </i> <a href="?p=show2&com=del&page=<?php echo $page;?>&id=<?php echo $cat_fetch_row['id']; ?>" onClick= "return confirm('Do You Want To Delete This Certificate?')">Delete</a> </span></td>
		</tr>
		<?php } ?>
  </tbody>
</table>
