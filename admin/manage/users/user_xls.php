...
//start while loop to get data Voucher Number
 $schema_insert1 = "Company Name".$sep."Job #".$sep."Voucher Number".$sep."Cert #".$sep."Concatenated".$sep."Amount".$sep."Shipped".$sep."Received".$sep."Fulfilled".$sep."Created On".$sep."Redemption Period Begin".$sep."Redemption Period End".$sep."Status".$sep."Certificate Status".$sep."Customer (Order)".$sep."Exported".$sep."First ".$sep."Last".$sep."Address".$sep."City".$sep."State".$sep."Zip".$sep."Phone Number".$sep."Email".$sep."Demonination".$sep."Invoice Number".$sep."Trip 1".$sep."Trip 2".$sep."Trip 3".$sep."Trip 4";
 echo $schema_insert1;
 print("\n"); 
