...
$admin= $title1['email'];
  ...
  <div style="background-image: url(https://www.pypvouchers.com/images/email_header.png); background-repeat: no-repeat; background-position: center top; height: 300px; border-left: 2px solid #B13427;
border-right: 2px solid #B13427;
border-top: 2px solid #B13427;"></div>

   <div style="background-image: url(https://www.pypvouchers.com/images/border.png); background-repeat: repeat-y; background-position: center center; border-left: 2px solid #B13427;
border-right: 2px solid #B13427;">
  ...
  <div style="background-image: url(https://www.pypvouchers.com/images/bottom.png); background-repeat: no-repeat; background-position: center top; height: 36px; width: 956px; border-left: 2px solid #B13427;
border-right: 2px solid #B13427;
...
<table width="1072"  cellpadding="0" cellspacing="0" border="0"  id="table" class="tinytable">
  ...
  if($ex==1)
  {
    ...
    ?></td>
            ...
            <td width="15%" align="left"> <span href="#" class="btn btn-small"> <i class="icon-delete "> </i> <a href="?p=viewuser&com=del&page=<?php echo $page;?>&id=<?php echo $cat_fetch_row['id']; ?>" onClick= "return confirm('Do You Want To Delete This User?')">Delete</a></span>  | <a href="?p=edituser2&id=<?php echo $cat_fetch_row['id']; ?>">Edit</a> </td>
		</tr>
		<?php } ?>
  </tbody>
</table>
