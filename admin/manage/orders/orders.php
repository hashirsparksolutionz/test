...
if($com=='empty'){
	...
	mysqli_query($con, "DELETE FROM userinfo WHERE `archive`='0' and s_check='1'");
	goUrl('?p=orders&mes=alldelete');
...
?>
<script type="text/javascript">
window.location.href='?p=orders&mes=up';
</script>
<?php }
...
$rslt=mysqli_query($con, "select * from `userinfo` WHERE `archive`='0' and s_check='1' ORDER BY id DESC");
?>

<div> <td colspan="2"><a href='?p=archOrder'>Show Archive Orders</a></div>
<?php
...
<tr>
  ...
  <tr>
    <td colspan="2" align="right"><a href="?p=orders&com=empty" onClick= "return confirm('Do You Want To Delete All Records From The System?')">Delete All Records</a></td>
  </tr>
...
?>
  ...
  <tr>
    <td height="62" colspan="3"><h2><strong>Profile Details <?php echo $counter++;?>:</strong></h2></td>
  <?php /*?>  <td colspan="3"><a style="float:right;" href="?p=orders&DelOrd=DeleteRec&id=<?php echo $rw1['id'];?>" class="delete" onclick="return confirm('Do You Want To Makes This Record Archive');"><img src="../images/arch.png" width="20" height="20" border="0">&nbsp;Archive</a></td><?php */?>
	<td colspan="3" align="right" valign="top" style="padding-top:25px;"><a href="?p=orders&DelOrd=DeleteRec1&OrdDetID=<?php echo $rw1['id'];?>" class="delete" onclick="return confirm('Do You Want To Delete This Record');"><img src="../images/cross.png" border="0" style="
    height: 27px;
    width: 25px;
">Delete</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  href="?p=orders&DelOrd=DeleteRec&id=<?php echo $rw1['id'];?>" class="delete" onclick="return confirm('Do You Want To Makes This Record Archive');"><img src="../images/arch.png" style="
    height: 27px;
    width: 25px;
" border="0">&nbsp;Archive</a></td>  
  </tr>
  <tr>
    <td width="85"><strong>Name:</strong></td>
    <td width="177"><?php echo $rw1['fname'].' '.$rw1['lname'];?></td>
    
    <td width="129"><strong>Email:</strong></td>
    <td width="241"><?php echo $rw1['email'];?></td>
     <td width="191"><strong>City/State</strong></td>
    <td width="93"><?php echo $rw1['city'].'/'.$rw1['state'];?></td>
  </tr>
  <tr>
    <td><strong>Address:</strong></td>
    <td><?php    $add=preg_replace('/[^a-zA-z0-9 ]/s',' ',$rw1['address1']); echo mysqli_real_escape_string($con, $add);?></td>
  ...
  <tr>
   ...
   <td><strong>Certificate:</strong></td>
	<td class="edit_td"><?php echo $rw1['vocher']; ?></td>
<td><strong>Used Certificate Date:</strong></td>
