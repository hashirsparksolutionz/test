		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span2 container-logo">
					<a class="logo" href=""><img src="../images/pickyourplastic1.png" alt="" border="0" width="200" height="50" /></a>
			  </div>
				<div class="span10">
					<h1 class="page-title" style="margin-top:50px; margin-left:35px">Control Panel</h1>
				</div>
			</div>
		</div>
	</header>
