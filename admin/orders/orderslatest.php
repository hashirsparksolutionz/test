...
$query1= mysqli_query($con, "select * from userinfo where id='".$rw['user_id']."'");
...
?>
  ...
  <tr>
    ...
    <td><?php $rows=mysqli_fetch_array($order_detail);echo $rows['ZIP']?></td>
    <td colspan="2">&nbsp;</td>
  </tr>
  <tr id="<?php echo $rw1['id']; ?>" class="edit_tr">
<td><strong>Certificate:</strong></td>
<td class="edit_td" colspan="5">
...
?>
    ...
    <td><?php if($rw['total_points']!="" && $order_detail_row['quantity']!="" ){ echo $rw['total_points'].' x '.$order_detail_row['quantity'].' = '."$".$rw['total_points']*$order_detail_row['quantity'];}?></td>
    <td><img src="../images/thumb_<?php echo $product_row['image']?>"; width='150' height="150" /></td>
  </tr>
  <?php } ?>
</table></td>
...
<?php }else{?><div style="margin-left: 215px;"><H2>Right Now, You Have No New Orders</H2></div><?php }?>