...
$rslt=mysqli_query("select * from orders where pendig=2 ORDER BY id DESC");
...
////////////////////////// Uers Qry///////////////////
$query1= mysqli_query("select * from members  where id='".$rw['user_id']."'");
...
$order_detail=mysqli_query($query2);
...
///////////////////////////////Product Table////////////////////////////////////
$product_query=mysqli_query("select * from `products`  where id='".$order_detail_row['prd_id']."'");
