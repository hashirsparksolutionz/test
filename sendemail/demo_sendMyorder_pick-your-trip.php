...
echo "select * from userinfo WHERE `s_check`='1' AND regDate >= '".$today3."'";
echo "<br/>";
...
//$email_to = array('waseem@pixiders.com' => 'Waseem ',  'altonalvin9@gmail.com' => 'Alton Alvin ',$to => 'admin');
$email_to = array(  'altonalvin9@gmail.com' => 'Alton Alvin ');
//$email_to = array('bareera@pixiders.com' => 'Bareera','nadeemehsan9@pixiders.com' => 'Nadeem Ehsan');
