...
if(isset($_GET['q']))
{
    ...
    $vals=  "<select name=\"city\" id=\"city\"   onChange=\"showHint1(this.value)\" class=\"select-width\">";
...
if(isset($_GET['p']))
{
	...
	echo "<input type='text' name=\"state\" id=\"state\" class=\"textBox\" value='".$ary1['statename']."'readonly=\"readonly\"/ >";
