...
$paypal['business']      = "mohsin-facilitator@pixiders.com";
$paypal['site_url']      = "http://dev.capitolmarketingdeals.com";
$paypal['image_url']     = "";
$paypal['success_url']   = "?p=Thankyou";
$paypal['cancel_url']    = "?p=PaymentError";
...
<?php /*?><input type="hidden" name="quantity" value="<?php echo $paypal['quantity']?>"> <?php */?>
