...
while($CartRows =	mysqli_fetch_array($CartQuery))
{
	...
	$consumed += ($CartRows['prdPOints']*$CartRows['quantity']);
...
<div id="header">
  ...
  <?php
		...
		?>
  <div style="float: right;margin-top: 2px; width:285px">
    <div style="width: 90px;height: 70px;background-image: url(images/cart.png);margin-left: 60px;float: left; margin-top:10px;"></div>
    <div style="float:left;font-size:70px;color:#702c8b;font-weight:bold;"><?php echo $cartTotalRows;?></div>
    <div class="header-text">Items <br>
      in basket<br>
<a href="?p=Cart" style="font-size: 17px;font-weight: bold;color:#bc0e0e !important;" class="cont-a">Check out</a></div>
  </div>
  <?php //} ?>
  ...
  <div style="width:208px; float:right;">
    <table width="100%">
      <tr>
        <td width="60%">&nbsp;</td>
        <td width="40%">&nbsp;</td>
          <strong>Shipping Price :</strong> <?php if(isset($_SESSION['abc'])){  $shippingPrice = $_SESSION['abc']; echo "$".$shippingPrice; }?>
      </tr>
       <?php if($consumed != ''){
		    ?>
       <tr>
      ...
      <tr>
        ...
        <td width="40%"><span class="cont-a">___
          </span></td>
      </tr>
      <tr>
...
?>
  ...
  <div class="navigation">
    <ul class="top-ul">
      ...
      <li class="top-li"><a href="?p=TOS" class="top-a">Terms Of Use</a></li>
...
<div class="slider">
  <div class="panel">
    <div class="title"></div>
    <div class="container">
      <div class="wt-rotator" style="max-width:960px !important;width:955px !important;">
        <div class="screen" style="max-width:960px !important;width:955px !important;">
          <noscript>
          ...
          <div class="thumbnails">
            <ul>
              <?php
					...
					?>
              <li> <a href="images/thumb_<?php echo $BannerQueryrows['bannerImages'];?>" title="temple">
              <img  width="150" height="150" src="images/thumbnew_<?php echo $BannerQueryrows['bannerImages'];?>" border="0" style="width:960px;"/></a> </li>
              <?php } ?>
            </ul>
            <?php /*?><ul>
                    <?php
