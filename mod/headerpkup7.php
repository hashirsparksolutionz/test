...
<li><a  href="?p=ManageProducts">Manage Products</a></li>
                                      <li class="divider"><span></span></li>
								        <li><a href="?p=AddProduct">Add Product</a></li>
</ul>
</li>
								  </ul>
...
<li class="dropdown"><a class="dropdown-toggle"  data-toggle="dropdown" href="#">Manage Orders<span class="caret"></span></a>
  <ul class="dropdown-menu">
<li><a  href="?p=orders">View All Orders</a></li>
<!--<li><a  href="?p=orders_a">Orders Awaiting</a></li>
<li><a  href="?p=orders_d">Orders delivered</a></li> -->
</ul>
</li>
								  </ul>
...
<li class="dropdown"><a class="dropdown-toggle"  data-toggle="dropdown" href="#">Slider<span class="caret"></span></a>
  <ul class="dropdown-menu">
 <li><a  href="?p=manageBanners">Manage Banners</a></li></ul>
</li>
								  </ul>
...
<li class="dropdown"><a class="dropdown-toggle"  data-toggle="dropdown" href="#">Users<span class="caret"></span></a>
 ...
 <li><a  href="?p=manageUsers">Manage Users</a></li></ul>
                                  ...
                                  <ul id="menu" class="nav ">
<li class="dropdown"><a class="dropdown-toggle"  data-toggle="dropdown" href="?p=show2">View Certificate<span class="caret"></span></a></li>
								  </ul>
...
<li class="dropdown"><a class="dropdown-toggle"  data-toggle="dropdown" href="#">About Us<span class="caret"></span></a>
  <ul class="dropdown-menu">
 <li><a  href="?p=updateAboutus">Manage About Us</a></li></ul>
</li>
								  </ul>
                                  ...
                                  <ul id="menu" class="nav ">
<li class="dropdown"><a class="dropdown-toggle"  data-toggle="dropdown" href="#">Faq Page<span class="caret"></span></a>
  <ul class="dropdown-menu">
 <li><a  href="?p=faq">Manage Faq</a></li></ul>
</li>
								  </ul>
                                  
                                  <ul id="menu" class="nav ">
<li class="dropdown"><a class="dropdown-toggle"  data-toggle="dropdown" href="?p=TermsOfUse">Manage Terms Of Use<span class="caret"></span></a></li>
								  </ul>
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span2 container-logo">
					<a class="logo" href=""><img src="../images/logo.png" alt="" border="0" /></a>
			  </div>
				<div class="span10">
		...
		<div class="sidebar-nav">
			<ul class="nav nav-list">
				...
				<li class="nav-header">Products</li>
							<li><a href="?p=AddProduct">Add New Product</a></li>
                            <li><a  href="?p=importCsv">Import CSV File</a></li>
                            <li><a  href="?p=updateAboutus">Manage About Us</a></li>
                            <li><a  href="?p=manageBanners">Manage Banners</a></li>
                            <li><a  href="?p=manageUsers">Manage Users</a></li>
						</ul>
		</div>
	</div>
    <div class="span6">