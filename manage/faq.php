...
{
$sql2="UPDATE  `cmattox_capitolmarketingdeals`.`aboutUs` SET  `aboutText` = '".$_POST['desc_en']."' WHERE  `aboutUs`.`id` =2;";
$res2=mysqli_query($con, $sql2);
?>

<script language="javascript">
window.location.href = "?p=faq&mes=Update";
</script>
<?php	
}

?>
<h2 class="table table-striped">Manage Your Faq</h2>
<?php if($_REQUEST['mes']== 'Update'){?>
<div class="alert alert-success">Faq Text Has Been Updated Successfully</div>
<?php } ?>
