...
$rslt=mysql_query("select * from orders where pendig=0 OR pendig=1 ORDER BY id DESC");
$totalRecs = mysql_num_rows($rslt);
...
////////////////////////// Uers Qry///////////////////
$query1= mysql_query("select * from members  where id='".$rw['user_id']."'");
$rw1=mysql_fetch_array($query1);
...
$order_detail=mysql_query($query2);
while($order_detail_row=mysql_fetch_assoc($order_detail)){
/////////////////////////////////////////////////////////////
$info['prd_name']=$order_detail_row['prd_name'];
$info['prd_id']=$order_detail_row['prd_id'];
$info['quantity']=$order_detail_row['quantity'];
///////////////////////////////Product Table////////////////////////////////////
$product_query=mysql_query("select * from `products`  where id='".$order_detail_row['prd_id']."'");
