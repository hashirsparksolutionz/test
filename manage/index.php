<?php
/*$con = mysql_connect("localhost","cmattox_pacauser","wS]lcu7qs%.(");
mysql_select_db("cmattox_pamperedchefus",$con) or trigger_error(mysql_error());*/


$con = mysqli_connect("localhost","cmattox_pacauser","wS]lcu7qs%.(", "cmattox_pamperedchefus") or trigger_error(mysqli_error($con));
